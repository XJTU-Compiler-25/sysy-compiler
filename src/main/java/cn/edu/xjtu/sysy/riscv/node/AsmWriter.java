...
public final class AsmWriter {
    ...
    private AsmWriter regw(Reg.Op op, Value dst, Register.Int rs1, Register.Int rs2) {
        ...
        switch(position) {
            ...
            case StackPosition(int offset, boolean isArgument) -> {
                ...
                sw(Register.Int.T0, getFP(isArgument), offset, Register.Int.T1);
            }
            default -> unreachable();
        }
        return this;
    ...
    private AsmWriter reg(Reg.Op op, Value dst, Register.Int rs1, Register.Int rs2) {
        ...
        switch(position) {
            ...
            case StackPosition(int offset, boolean isArgument) -> {
                instrs.add(new Reg(op, Register.Int.T0, rs1, rs2));
                sd(Register.Int.T0, getFP(isArgument), offset, Register.Int.T1);
            }
            default -> unreachable();
        }
        return this;
    ...
    private AsmWriter funary(FUnary.Op op, Value rd, Register.Float rs1) {
        ...
        switch(position) {
            ...
            case StackPosition(int offset, boolean isArgument) -> {
                ...
                fsw(Register.Float.FT0, getFP(isArgument), offset, Register.Int.T1);
            }
            default -> unreachable();
        }
        return this;
