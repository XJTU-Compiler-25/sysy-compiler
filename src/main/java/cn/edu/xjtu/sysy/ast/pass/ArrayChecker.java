...
public class ArrayChecker {
    ...
    /** 获取当前index对应的深度（1 <= depth <= dimensions.length)
     *  eg. 
     *  [2][3][4] index = 0 -> depth = 0
     *  [2][3][4] index = 1 -> depth = 3
     *  [2][3][4] index = 4 -> depth = 2
     *  [2][3][4] index = 12 -> depth = 1
     */
